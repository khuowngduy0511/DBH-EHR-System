 ...
 * @property {string} type           - Always "AUDIT_CREATED"
 * @property {string} auditId        - Unique log ID (format: "AUDIT_{recordId}_{timestamp}")
 * @property {string} actorDid       - DID of the user who performed the action
 * @property {string} action         - What was done (e.g., "READ", "EMERGENCY_READ")
 * @property {string} targetType     - The type of record accessed (e.g., "EHR")
 * @property {string} targetId       - The ID/DID of the record that was accessed
 * @property {string} txId           - Fabric Transaction ID for traceability
