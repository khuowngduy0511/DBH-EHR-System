        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    credential_value = table.Column<string>(type: "text", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "users",
                columns: new[] { "user_id", "address", "created_at", "date_of_birth", "department_id", "email", "full_name", "gender", "password", "phone", "public_key", "status" },
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, "admin@dbh.com", "Admin User", null, "$2a$11$ocTsCaCPgh.8rqgEIPOPCed2b5ZrCnE.g2moUq4dVfrgTN6AJgnRu", "1234567890", null, "Active" },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, "doctor@dbh.com", "Dr. House", null, "$2a$11$lHwzf6S3mdiZTZEaOOdmuuIKjE0CtrkhzY0qaIr6Uj2cUju/SNdbK", "1234567891", null, "Active" },
                    { new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, "pharmacist@dbh.com", "Pharma Joe", null, "$2a$11$d73zj94eE3YeHBhlDYZ.FeYfwpRUbKlgHf/d59a9F.SuCe6.zI2a.", "1234567892", null, "Active" },
                    { new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, "nurse@dbh.com", "Nurse Joy", null, "$2a$11$NIxM7qpA5wNMCX04lLZV5uExInp93V3xIBHHws4z5x3sl3nfNSG9O", "1234567893", null, "Active" },
                    { new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, "patient@dbh.com", "John Doe", null, "$2a$11$S3AblAwIUvZq.BIV7zNVrO0/oDzPLSsBlPy1WiNPTRv.wrXNmuSfG", "1234567894", null, "Active" },
                    { new Guid("ffffffff-ffff-ffff-ffff-ffffffffffff"), null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, null, "receptionist@dbh.com", "Pam Beesly", null, "$2a$11$lx8vIgcr2qLvRON1LcaHROlFVkhYi1v1uoHdG5wLf1gybfJziXkGe", "1234567895", null, "Active" }
                });
