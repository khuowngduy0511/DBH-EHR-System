...
public class AuthServiceTests : ApiTestBase
{
    ...
    public async Task Login_WithAdminCredentials_ShouldReturnTokenAndUserData()
    {
        ...
        Assert.Equal("Login successful", json.GetProperty("message").GetString());
    ...
    public async Task GetMyProfile_AsAdmin_ShouldReturnAdminData()
    {
        ...
        var data = json.GetProperty("data");
        Assert.Equal(TestSeedData.AdminEmail, data.GetProperty("email").GetString());
        Assert.Equal(TestSeedData.AdminFullName, data.GetProperty("fullName").GetString());
    }
    ...
    public async Task GetMyProfile_AsDoctor_ShouldReturnDoctorData()
    {
        ...
        var json = await ReadJsonResponseAsync(response);
        var data = json.GetProperty("data");
        Assert.Equal(TestSeedData.DoctorEmail, data.GetProperty("email").GetString());
        Assert.Equal(TestSeedData.DoctorFullName, data.GetProperty("fullName").GetString());
    }
