...
public class EhrServiceTests : ApiTestBase
{
    ...
    public async Task CreateEhrRecord_WithSeedData_ShouldReturnMessage()
    {
        ...
        var request = new { patientId = TestSeedData.PatientUserId, doctorId = TestSeedData.DoctorUserId, organizationId = TestSeedData.HospitalAOrgId, encounterId = Guid.NewGuid(), diagnosis = "Common cold", treatment = "Rest", notes = "Follow-up in 7 days" };
