...
/// <summary>
/// Bad case: Try to update EHR record with invalid data (null diagnosis, etc.)
/// Expected: 400 Bad Request or validation error
/// </summary>
public class EhrServiceTests_UpdateEhrRecord_WithInvalidData_ShouldReturnBadRequest : ApiTestBase
{
    ...
    [SkippableFact]
    public async Task UpdateEhrRecord_WithInvalidData_ShouldReturnBadRequest()
    {
        ...
        // Try to update with null data (invalid)
        ...
        Assert.True(
            ...
            updateResponse.StatusCode == HttpStatusCode.UnprocessableEntity,
            $"Expected 400 or 422, got {updateResponse.StatusCode}");
    }
}
