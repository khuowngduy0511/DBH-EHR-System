...
/// <summary>
/// Bad case: Try to upload file to non-existent EHR
/// Expected: 404 Not Found
/// </summary>
public class EhrServiceTests_AddEhrFile_WithNonExistentEhr_ShouldReturnNotFound : ApiTestBase
{
    ...
    [SkippableFact]
    public async Task AddEhrFile_WithNonExistentEhr_ShouldReturnNotFound()
    {
        ...
        var response = await EhrClient.PostAsync(
            ApiEndpoints.Ehr.AddFile(fakeEhrId), 
            fileContent);
