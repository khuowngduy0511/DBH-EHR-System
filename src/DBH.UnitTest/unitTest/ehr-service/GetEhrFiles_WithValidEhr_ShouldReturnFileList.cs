...
/// <summary>
/// Good case: Retrieve all files attached to an EHR record
/// Expected: 200 OK with file list
/// </summary>
public class EhrServiceTests_GetEhrFiles_WithValidEhr_ShouldReturnFileList : ApiTestBase
{
    ...
    [SkippableFact]
    public async Task GetEhrFiles_WithValidEhr_ShouldReturnFileList()
    {
        ...
        Assert.True(filesJson.ValueKind == JsonValueKind.Array, "Should return array of files");
    }
}
