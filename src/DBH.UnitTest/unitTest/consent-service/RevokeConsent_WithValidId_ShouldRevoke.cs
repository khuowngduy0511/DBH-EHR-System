...
/// <summary>
/// Good case: Revoke an existing consent
/// Expected: 200 OK
/// </summary>
public class ConsentServiceTests_RevokeConsent_WithValidId_ShouldRevoke : ApiTestBase
{
    ...
    [SkippableFact]
    public async Task RevokeConsent_WithValidId_ShouldRevoke()
    {
        ...
        var consentId = Guid.Parse(consentIdElement.GetString()!);

        // Now revoke it
        var revokeRequest = new { reason = "Patient revokes consent" };
        ...
        Assert.True(
            ...
            $"Expected 200 or 204, got {revokeResponse.StatusCode}");
    }
}
