...
/// <summary>
/// Good case: Grant consent with valid patient and grantee IDs
/// Expected: 201 Created
/// </summary>
public class ConsentServiceTests_GrantConsent_WithValidUsers_ShouldCreateConsent : ApiTestBase
{
    ...
    [SkippableFact]
    public async Task GrantConsent_WithValidUsers_ShouldCreateConsent()
    {
