...
/// <summary>
/// Good case: Verify consent between two users
/// Expected: 200 OK with verification result
/// </summary>
public class ConsentServiceTests_VerifyConsent_WithValidUsers_ShouldReturnVerification : ApiTestBase
{
    ...
    [SkippableFact]
    public async Task VerifyConsent_WithValidUsers_ShouldReturnVerification()
    {
